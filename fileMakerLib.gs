...
function duplicateSpreadsheets(folderId, files, section = 0) {
  ...
  while (files.hasNext()) {
    ...
    var temp_id = temp.makeCopy(fileName, DriveApp.getFolderById(folderId));
   // console.log(temp_id.getId());
  }
  return returnedID;
}
...
/**Layout of folderIds
 * [ '1HagZSoyuLfwBqCfbSjIw23CyjmE1ttnY', //1
  [ '1lLxI2uy_MmrzJ8ZhI2DplLC2owRGlFVh', 
    ...
    '1gILNR5eJHGfGupigTppKLPSAcOs4CWxW' ], //2
  [ '1HI_ZLnu-6BAgno_GkzO2J9xiqCC2x0V0',
    ...
    '19_C4MU7NLXSDK9jTfXqCExikMeA0LRJO' ], //3
  [ '182oxvFknge-ryf_SN9uir81z4VYQzWn0',
    ...
    '1GpJkOArrpE8XsaxDWG9lvPI_rgM0HLrp' ], //4
  [ '1SCQw3GSxa162C0eWp4rw3opeGZq3YnWS',
    ...
    '1ZhMUoNd6gzlYbVeEZkImHwajryPFI5lu' ],//5
  [ [ '1xLkxhYODNIeKGaUs95bdCzQSKyzuJXSW', -1 ], // 5,0
    
      [ 
      '1IXqhT48JB5RsnE8Z0P1xIPY82ITVqNre', //5,0,0
        -1
     ],
    [ '1VDW3SF7LF8LgLzmsGONbSUnnECBHio5d', -1 ],
    [ '14-ZVLavWUphVjkQgBcg92tUP9-bG8b1Y', -1 ],
    [ '1t2GgbcL7uC5cFGwN_XPZsk7Ds8aWbdwC', -1 ],
    [ '12ch__kwTpb8Yby1RzPfPOLr-f0Bi9uZc', -1 ] ] //6 (aka 5), then inside we take [0] for example
    ] 
